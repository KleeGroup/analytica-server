...
public class SObserverObjectPanel extends SObjectPanel implements Observer {
	...
	/**
	 * Signale que l'objet associé é ce Panel a envoyé une notification de modification.
	...
	public void update(final Observable observable, final Object object) {
		//sae.client.log.ClientLog.fine("updateObserver reéu dans " + getClass() + " pour " + observable);
