...
public class CollUtils {
	...
	/**
	 * Clone une liste de maniére aussi performante que possible et synchronisée.
	...
	public static List cloneList(final Collection list) {
		synchronized (list) {
			// on construit par un clone une List de méme type (ex : TypedArrayList), que la liste originale
	...
	/**
	 * Renvoie é partir d'une collection, une map dont les clés sont les valeurs d'une propriété.
